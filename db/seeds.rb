...
test1 = Test.create(title: 'RoR', level: 'beginner', category: category1)
test2 = Test.create(title: 'RoR', level: 'pro', category: category1)
test3 = Test.create(title: 'Ruby', level: 'beginner', category: category1)
test4 = Test.create(title: 'Ruby', level: 'pro', category: category1)
test5 = Test.create(title: 'Car driving', level: 'beginner', category: category2)
test6 = Test.create(title: 'Car driving', level: 'pro', category: category2)
